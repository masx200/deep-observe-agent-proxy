    ...
    ? (function n(y, c, s = [], w = y) {
        ...
        if (d(y) || P(y)) {
          ...
          return (
            ...
            (v =>
              new Proxy(v, {
                defineProperty: (t, e, r) => o(y, e, r),
                deleteProperty: (e, r) => (
                  c(w, [...s, r], void 0, f(y, r)), t.deleteProperty(y, r)
                ),
                ownKeys: () => t.ownKeys(y),
                has: (t, e) => u(y, e),
                getPrototypeOf: () => p(y),
                ...
                construct(e) {
                  if ("function" == typeof y) return r(y, e);
                },
                apply(r, o) {
                  if ("function" == typeof y) return e(y, r, o);
                },
                ...
                set: (t, e, r) => (
                  "function" == typeof c && c(w, [...s, e], r, f(y, e)),
                  l(y, e, r)
                ),
                get(e) {
                  var r = f(y, e);
